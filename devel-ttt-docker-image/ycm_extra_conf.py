...
def FlagsForFile( filename, **kwargs ):
  if database:
    ...
    final_flags.extend( ['-fplugin=/root/ClanPlugin/lib/ClanPlugin.so', '-Xclang', '-plugin-arg-clan', '-Xclang', '-emit-openmp'] )
    final_flags.extend( ['-Xclang', '-plugin-arg-clan', '-Xclang', '-redirect-stdout', '-Xclang', '-plugin-arg-clan', '-Xclang', 'out'] )
    final_flags.extend( ['-Xclang', '-plugin-arg-clan', '-Xclang', '-redirect-stderr', '-Xclang', '-plugin-arg-clan', '-Xclang', 'err'] )
