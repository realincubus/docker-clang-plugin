...
void initiate(double (*x)[N], double (*y)[N], double (*nx_old)[N],
              double (*ny_old)[N], double (*nx_new)[N], double (*ny_new)[N],
              double (*sumnx)[N], double (*sumny)[N], double (*r)[N],
              double (*nx_temp)[N], double (*ny_temp)[N], double (*v)[T],
              double complex (*Ax)[T], double complex (*Ay)[T],
              double complex (*A1)[T], double complex (*Wk)[T],
              double complex (*Ax_complex)[T], double complex (*Ay_complex)[T],
              double complex (*A1_complex)[T],
              double complex (*Wk_complex)[T]) {
  int i;
  for (i = 0; i < N; i++) {
